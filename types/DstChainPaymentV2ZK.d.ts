...
interface DstChainPaymentV2ZKInterface extends ethers.utils.Interface {
  functions: {
    ...
    "payWithZK(uint64,bytes32,bytes32,tuple[],uint256,uint256,bytes)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "payWithZK", data: BytesLike): Result;
  ...
  events: {
    ...
    "PaidFromSrc(uint64,bytes32,address,bytes32,tuple[],uint256,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PaidFromSrc"): EventFragment;
...
export type PaidFromSrcEvent = TypedEvent<
  [
    BigNumber,
    string,
    string,
...
export class DstChainPaymentV2ZK extends BaseContract {
  ...
  interface: DstChainPaymentV2ZKInterface;
  ...
  filters: {
    ...
    "PaidFromSrc(uint64,bytes32,address,bytes32,tuple[],uint256,uint256,uint256)"(
      srcChainId?: null,
      srcTxHash?: null,
      provider?: null,
      account?: null,
