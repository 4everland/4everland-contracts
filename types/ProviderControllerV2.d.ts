...
interface ProviderControllerV2Interface extends ethers.utils.Interface {
  functions: {
...
export class ProviderControllerV2 extends BaseContract {
  ...
  interface: ProviderControllerV2Interface;
