...
interface SrcChainRechargeInterface extends ethers.utils.Interface {
  functions: {
    "addPauser(address)": FunctionFragment;
    "calcFee(address,bytes32)": FunctionFragment;
    "encodeMessage(address,bytes32)": FunctionFragment;
    ...
    "recharge(address,bytes32,uint256,uint64,uint32)": FunctionFragment;
  ...
  events: {
    ...
    "Recharge(address,bytes32,uint256,uint64,uint32)": EventFragment;
    "RechargeMessageSenderUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "Recharge"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "RechargeMessageSenderUpdated"
  ): EventFragment;
...
export type RechargeEvent = TypedEvent<
...
export type RechargeMessageSenderUpdatedEvent = TypedEvent<
...
export class SrcChainRecharge extends BaseContract {
  ...
  interface: SrcChainRechargeInterface;
