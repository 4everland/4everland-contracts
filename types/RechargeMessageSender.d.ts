...
interface RechargeMessageSenderInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setSrcChainRecharge(address)": FunctionFragment;
    "srcChainRecharge()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setSrcChainRecharge",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "srcChainRecharge",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class RechargeMessageSender extends BaseContract {
  ...
  interface: RechargeMessageSenderInterface;
  ...
  functions: {
    ...
    srcChainRecharge(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    srcChainRecharge(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    srcChainRecharge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
