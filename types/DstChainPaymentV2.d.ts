...
interface DstChainPaymentV2Interface extends ethers.utils.Interface {
  functions: {
...
export class DstChainPaymentV2 extends BaseContract {
  ...
  interface: DstChainPaymentV2Interface;
